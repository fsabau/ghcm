...
class FiniteDifferenceSolver(eqx.Module):
  static_kernel_kind: str = eqx.field(static=True, default_factory=lambda: "linear")
  scale: float = 1e0
  multi_gpu: bool = eqx.field(static=True, default_factory=lambda: bool)
  static_kernel: Callable = eqx.field(static=True)

  def __init__(self, static_kernel_kind: str = 'linear', scale: float = 1e0, multi_gpu: bool = False):
